            ...
            <div class="flex justify-between items-center h-14 md:h-16">
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        <span class="text-lg md:text-xl font-bold text-indigo-600 dark:text-indigo-400">Tracking Pengeluaran</span>
                    </a>
                </div>
                ...
                <div class="flex items-center space-x-2 md:space-x-3 shrink-0">
                    ...
                    <form action="{{ route('logout', [], false) }}" method="POST" class="shrink-0">
                        @csrf
                        <button type="submit" class="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 active:bg-gray-200 dark:active:bg-gray-600 transition-all btn-press" title="Keluar" aria-label="Keluar">
