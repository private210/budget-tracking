...
<div class="space-y-4 md:space-y-6">
    ...
    <div class="fade-in-card bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-4 md:p-6 border border-gray-200 dark:border-gray-700">
        ...
        <form action="{{ route('budget.salary.store') }}" method="POST" class="space-y-4">
            @csrf
    ...
    @if($salary)
        <div id="alloc-form" class="fade-in-card bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-4 md:p-6 border border-gray-200 dark:border-gray-700">
            ...
            <form action="{{ route('budget.allocate') }}" method="POST" class="space-y-4">
                @csrf
...
<script>
    ...
    function confirmSaveAllocate() {
        showConfirm({
            ...
            onConfirm: function() {
                document.querySelector('form[action="{{ route('budget.allocate') }}"]').submit();
            }
        });
    }
