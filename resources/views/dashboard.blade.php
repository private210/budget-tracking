...
<div class="space-y-4 md:space-y-6">
    ...
    <div class="grid grid-cols-2 gap-3 md:gap-4">
        <div class="stat-card fade-in-card bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-4 md:p-5 border border-gray-200 dark:border-gray-700">
            ...
            <p class="text-lg md:text-2xl font-bold text-gray-900 dark:text-white truncate mt-1">Rp {{ number_format($salary?->amount ?? 0, 0, ',', '.') }}</p>
        </div>
        <div class="stat-card fade-in-card bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-4 md:p-5 border border-gray-200 dark:border-gray-700">
            ...
            <p class="text-lg md:text-2xl font-bold text-blue-600 dark:text-blue-400 truncate mt-1">Rp {{ number_format($totalAllocated, 0, ',', '.') }}</p>
        </div>
        <div class="stat-card fade-in-card bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-4 md:p-5 border border-gray-200 dark:border-gray-700">
            ...
            <p class="text-lg md:text-2xl font-bold text-red-600 dark:text-red-400 truncate mt-1">Rp {{ number_format($totalSpent, 0, ',', '.') }}</p>
        </div>
        <div class="stat-card fade-in-card bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-4 md:p-5 border border-gray-200 dark:border-gray-700">
            ...
            <p class="text-lg md:text-2xl font-bold {{ $remaining >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }} truncate mt-1">Rp {{ number_format($remaining, 0, ',', '.') }}</p>
        </div>
    </div>
